/**
 * @title: GUICliente.java
 * @description: GUI de clientes para el proyecto CadenaSuministros.
...
public class GUICliente extends javax.swing.JFrame {
    ...
    private ControladorCliente proCliencont;
    Cliente usuario;
    ConexionBD conBD;
    Connection con;
    Object[] arregloDatos;
    ...
    public GUICliente() {
        ...
        arregloDatos = new Object[7];
        Modelo = (DefaultTableModel)jTMC.getModel();
        consultarDB();
    ...
    //Metodo para insertar los atributos en la tabla de la interfaz grafica 
    private void insertarTabla(Cliente usuario){
        //Atributos de usuario
    ...
    //Trae los datos de la base de datos a la tabla desde el workbench 
    private void consultarDB(){
        
        try{
            Statement stmt = con.createStatement();
            ResultSet rsClien = stmt.executeQuery("SELECT * FROM ferreteria.cliente");
            
            while(rsClien.next()){
                usuario = new Cliente();
                
                arregloDatos[0] = rsClien.getInt(1); //Cedula
                usuario.setCedula(rsClien.getInt(1));
                
                arregloDatos[1] = rsClien.getString(2); //Nombre
                usuario.setNombre(rsClien.getString(2));
                
                arregloDatos[2] = rsClien.getString(3); //Apellido
                usuario.setApellido(rsClien.getString(3));
                
                arregloDatos[3] = rsClien.getString(4); //Direccion
                usuario.setDireccion(rsClien.getString(4));
                
                arregloDatos[4] = rsClien.getInt(5); //Telefono
                usuario.setTelefono(rsClien.getInt(5));
                
                arregloDatos[5] = rsClien.getString(6); //Correo
                usuario.setEmail(rsClien.getString(6));
                
                arregloDatos[6] = rsClien.getString(7); //Fecha de nacimiento
                usuario.setFechanacimiento(rsClien.getString(7));
                                
                usuario.setContrasena(rsClien.getString(8));
                
                if(proCliencont.insertar(usuario)){
                    Modelo.addRow(arregloDatos);
    ...
    private void initComponents() {
        ...
        FranjaD.setBackground(new java.awt.Color(255, 204, 0));
        ...
        cedula.setBackground(new java.awt.Color(255, 204, 102));
        ...
        OrdenarID.setBackground(new java.awt.Color(255, 204, 51));
        ...
        OrdenarTelefono.setBackground(new java.awt.Color(255, 204, 51));
        ...
        OrdenarApellido.setBackground(new java.awt.Color(255, 204, 51));
        ...
        OrdenarNombre.setBackground(new java.awt.Color(255, 204, 51));
        ...
        Consultar.setBackground(new java.awt.Color(255, 204, 51));
        ...
        Actualizar.setBackground(new java.awt.Color(255, 204, 51));
        ...
        Insertar.setBackground(new java.awt.Color(255, 204, 51));
        ...
        Apellido.setBackground(new java.awt.Color(255, 204, 102));
        ...
        Contraseña.setBackground(new java.awt.Color(255, 204, 102));
        ...
        Nombre.setBackground(new java.awt.Color(255, 204, 102));
        ...
        Telefono.setBackground(new java.awt.Color(255, 204, 102));
        ...
        Correo.setBackground(new java.awt.Color(255, 204, 102));
        ...
        FechaNacimiento.setBackground(new java.awt.Color(255, 204, 102));
        ...
        jTMC.setBackground(new java.awt.Color(255, 204, 102));
        jTMC.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        jTMC.setFont(new java.awt.Font("Segoe UI Symbol", 0, 12)); // NOI18N
        jTMC.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Cédula", "Nombre", "Apellido", "Direccion", "Teléfono", "Correo", "Fecha de Nacimiento "
            }
        ) {
        ...
        jTMC.setGridColor(new java.awt.Color(0, 0, 0));
        jTMC.setShowHorizontalLines(true);
        jTMC.setShowVerticalLines(true);
        jTMC.setSurrendersFocusOnKeystroke(true);
        jTMC.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTMCMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTMC);
                ...
                .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(FondoLayout.createSequentialGroup()
                        ...
                        .addGroup(FondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(FondoLayout.createSequentialGroup()
                                .addComponent(OrdenarID, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void BorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BorrarActionPerformed
        ...
        if(cedula.getText().equals("")){
            ...
            //Inicializacion de variable temporal 
            int Cedula = Integer.parseInt(cedula.getText());
            
            //El ciclo recorre fila por fila en busca del cliente usuario insertado 
            for(int i = 0; i < Modelo.getRowCount(); i++){
                if(Cedula == (int) Modelo.getValueAt(i, 0)){
                    ...
                    if(proCliencont.borrar(usuario)) {
                        Modelo.removeRow(i);
                        proCliencont.borrar(usuario);
                        try {
                            //Borra al cliente mediante la instruccion del sql y la ejecuta 
    ...
    private void OrdenarIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OrdenarIDActionPerformed
        ...
        for(Cliente usuario1: proCliencont.arregloCliente){
            insertarTabla(usuario1);
        }
    }//GEN-LAST:event_OrdenarIDActionPerformed

    //Metodo para ordenar el numero telefonico mediante mergesort 
    ...
    //Metodo para ordenar por apellido mediante burbuja 
    ...
    //Metodo para consultar a un usuario desde el arreglo 
    private void ConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConsultarActionPerformed
        ...
        if(cedula.getText().equals("")){
            ...
            //El ciclo recorre fila por fila en busca del objeto seleccionado 
            for (int i = 0; i < Modelo.getRowCount(); i++) { 
                if (Cedula == (int) Modelo.getValueAt(i, 0)) { 
                    usuario = proCliencont.arregloCliente.get(i);
                    //Atributos de Usuario
                    ...
                    //Se desactiva el campo cedula para que no se pueda modificar 
    ...
    private void ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActualizarActionPerformed
        ...
        if(cedula.getText().equals("")){
            ...
            //El ciclo recorre fila por fila el objeto seleccionado a actualizar
            for(int i = 0; i < Modelo.getRowCount(); i++){
                if(Cedula == (int)  Modelo.getValueAt(i, 0)){
                    usuario = new Cliente();
                    usuario.setCedula(Integer.parseInt(cedula.getText()));
                    ...
                    if(proCliencont.insertar(usuario)) {
                        ...
                        LimpiarCajasDeTexto();
                        //El campo solo es manipulable para consulta y actualizacion 
                        cedula.setEnabled(true);
                    }else{
    ...
    private void InsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertarActionPerformed
        ...
        //Atributos de Usuario
        //Se convierten los campos a texto 
        usuario.setCedula(Integer.parseInt(cedula.getText()));
        usuario.setNombre(Nombre.getText());
        usuario.setApellido(Apellido.getText());
        usuario.setDireccion(Direccion.getText());
    ...
    //Metodo para rellenar los textfields de la interfaz grafica 
    private void jTMCMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTMCMouseClicked
        // TODO add your handling code here:
        for(int i = 0; i < Modelo.getRowCount(); i++){
            if(proCliencont.borrar(usuario)) {
                Modelo.removeTableModelListener(jTMC);
            }
        }    
        consultarDB();
        proCliencont.consultarGeneral();
        int pos = jTMC.getSelectedRow();
        System.out.println("pos: " + pos);


        try {
            if (pos >= 0 && pos < proCliencont.arregloCliente.size()) {
                usuario = proCliencont.arregloCliente.get(pos);
    ...
    }//GEN-LAST:event_jTMCMouseClicked
...
//    }
    ...
    private javax.swing.JTable jTMC;
